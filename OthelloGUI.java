...
public class OthelloGUI {
   ...
   // identification for each player
   ...
   */ 
   ...
   // Initializes MAXGAME, logoIcon, and iconFile with the information read from
   // the config.txt file.
   ...
   */
   ...
   /**
   * Display a dialog box that allows user to choose between single-player and
